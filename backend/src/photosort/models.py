...
class ProjectCamera(Base):
    ...
    PROJEKTEIGEN, nicht projektuebergreifend (ADR 0090, Punkt 2): "der Versatz gilt nur in diesem
...
class Photo(Base):
    ...
    # DIE KORRIGIERTE ZEIT - "die Zeit, mit der die Anwendung arbeitet" (ADR 0090, Punkt 1). Der
