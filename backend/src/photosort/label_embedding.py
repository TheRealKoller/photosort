...
class LabelEmbedderLike(Protocol):
    """Schmale, injizierbare Schnittstelle - bewusst SYNCHRON (reine, schnelle
...
def _mean_pool_and_normalize(
    ...
    Modelle dieser Familie): mittelt die Token-Embeddings NUR ueber tatsaechlich
...
def build_label_embedder() -> LabelEmbedderLike:
    """Baut das echte, lokale Text-Embedding-Modell: laedt den gepinnten
