...
# rate_limit.py::limiter (das trotz des aehnlichen Namens etwas voellig anderes tut: es begrenzt
# EINGEHENDE Anfragen an POST /auth/login).
#
...
# Importzyklus). Der MECHANISMUS (CloudRequestThrottle) bleibt deshalb dort, nur die INSTANZEN leben
# hier.
#
# Die Rate gilt fuer BEIDE Cloud-Teilschritte gemeinsam und fuer alle gleichzeitig laufenden Jobs:
# ein Lauf verlangsamt dadurch den anderen. Genau so gewollt - der Anbieter sieht ohnehin nur eine
# einzige Quelle.
#
...
# tests/test_config.py::test_the_resolution_never_returns_zero.
