...
# (ADR 0088, Punkt 1). `assert_time_offset_invariant` laeuft als Nachsatz jedes Falls, der hier
# Fotos schreibt.
...
async def test_the_same_camera_in_two_projects_gets_two_rows(
    ...
    """ADR 0088, Punkt 2: projekteigene Zeilen. Jedes Foto zeigt auf die seines EIGENEN
