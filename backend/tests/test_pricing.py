...
class TestEstimateUsdPerImage:
    ...
    def test_the_default_models_are_pinned_to_their_literal_amounts(self) -> None:
        """Die Kostenanzeige des Regelbetriebs, LITERAL ausgeschrieben und nicht aus der Rechnung
