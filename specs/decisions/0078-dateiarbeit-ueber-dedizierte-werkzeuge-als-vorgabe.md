...
- **Der tragende Satz zuerst.** Die Nadelliste beginnt mit der Regel selbst — „Freitext ist immer ein abgegrenzter Wert, nie Teil der Aufrufstruktur" —, erst danach kommen ihre drei `gh`-Konkretisierungen. Ohne die Regel-Überschrift bliebe ein Umbau möglich, der die Bullets stehen lässt und die Regel darüber umschreibt.
