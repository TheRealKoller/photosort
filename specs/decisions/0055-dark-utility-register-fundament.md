...
**Teilweise abgelöst:** durch [`0064-penpot-als-design-quelle-rangfolge-umgekehrt.md`](./0064-penpot-als-design-quelle-rangfolge-umgekehrt.md). Betroffen ist ausschließlich der Satz der Begründung „Board-Werte sind eine Vorlage, kein Gesetz" **in seiner vorwärtsgerichteten Wirkung**: Die Design-Quelle ist seit ADR 0064 für die Gestaltung normativ, und sie heißt Penpot statt Figma. **Alle acht Entscheidungspunkte gelten unverändert weiter**, insbesondere Punkt 4 — die Kontrast-Untergrenze schlägt den Wert der Design-Quelle; ADR 0064 Abschnitt 4 schreibt genau diese Regel fort und wendet sie auf Penpot an. Kein `Superseded`: Der Kern dieser Entscheidung (dunkel als einziges Schema, Token-Architektur, Konfliktauflösung, Kategorie-Chips, Symbolsatz, Zielflächen) fällt nicht.
