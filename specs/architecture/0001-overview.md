...
**Letzte Aktualisierung:** 2026-07-21 (Spec "Auth-Implementierung" (0006) umgesetzt: `POST /auth/login`, `get_current_user`-Dependency, `User`-Modell, Seed-Migration, Frontend-Login-Flow — siehe Feature-Branch `feature/0006-auth`. Zuvor am 2026-07-20: Auth-Ansatz — JWT via Bearer-Header, Argon2/PyJWT — gemäß [`decisions/0005-auth-implementation.md`](../decisions/0005-auth-implementation.md) entschieden; Frontend-Grundgerüst — Routing/Server-State — gemäß [`decisions/0004-frontend-app-shell.md`](../decisions/0004-frontend-app-shell.md))
