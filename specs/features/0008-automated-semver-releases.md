...
- [x] Neuer Workflow `.github/workflows/release-please.yml` (Trigger `push: branches: [main]`, `permissions: contents: write, pull-requests: write`) läuft additiv zu `ci.yml` — `ci.yml` selbst bleibt unverändert.
