...
steht in ADR [`0084`](../decisions/0084-frueheres-qualitaets-feedback-ein-pruefbefehl-und-ein-pruefpunkt-je-tdd-einheit.md).
...
**Entscheidung:** ADR [`0084`](../decisions/0084-frueheres-qualitaets-feedback-ein-pruefbefehl-und-ein-pruefpunkt-je-tdd-einheit.md).
...
10. **Nachweis der Randbedingung** (K5), als Messung im Abschlussbericht statt als neuer Testcode:
    ...
    und melden null Befunde. Begründung, warum nicht erweitert wird: ADR 0084 Abschnitt 7.
...
- **Eine exakte Fixierung von `mypy`.** `mypy>=1.13` kann lokal grün und in CI rot sein. Das
  ...
  ADR 0084 als bekannte Restschwäche benannt.
