...
- **ProjectCamera** *(implementiert, Spec
  ...
  [`decisions/0088-korrigierte-zeit-ist-die-aufnahmezeit-kamera-je-projekt.md`](../specs/decisions/0088-korrigierte-zeit-ist-die-aufnahmezeit-kamera-je-projekt.md),
