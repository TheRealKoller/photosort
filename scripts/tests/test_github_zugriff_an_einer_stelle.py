...
Seit ADR 0061 gibt es dafuer einen einzigen Ort: `.claude/skills/github-access/SKILL.md`. Jede
...
"Erweiterung fuer ADR 0061", Regel 3):
...
ihn zu glauben. Eine Verbliste waere zudem loechrig: `gh auth status` ist exakt die von ADR 0061
...
ERWARTETE_STUFEN: dict[str, str] = {
    ...
    ".claude/skills/produktentscheidung/SKILL.md": STUFE_KEINE,
