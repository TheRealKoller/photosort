 ...
 * verfehlt). Nur ein dekorativer, `aria-hidden` Punkt traegt die Farbe, der Text daneben bleibt
 * neutral (`text-text`/`text-text-h`).
 *
...
export function StatusDot({ status }: { status: ProcessStatus | null | undefined }) {
  return (
    <span
      aria-hidden="true"
      // Rueckfallfarbe "kein Status" auf --separator statt --border: der Punkt steht unmittelbar
      // auf --bg/--surface und erreichte dort mit --border nur 1.45:1 - er war faktisch nicht
      // vorhanden. Jetzt 2.38:1.
