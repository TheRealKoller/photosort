 ...
 * dreizehntes Symbol zu erweitern waere eine Gestaltungsentscheidung ohne Vorlage. Sie sind
 * untereinander ausschliesslich ueber ihren TEXT unterscheidbar - das ist der Grund, warum die Tests die
 ...
 * CriterionDetailsList strukturiert (`<dl>`, kein Card-Rahmen, "Die Fotos sind der Star"). Rendert IMMER genau die uebergebenen Eintraege ohne eigene
