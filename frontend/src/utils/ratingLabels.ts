...
// Farb-/Symbol-Zuordnung des Design-Systems: Bewertungsstufen sind auf einen Blick
// unterscheidbar - Farbe UND Symbol, nicht nur Text. Eigene Datei statt Export aus
