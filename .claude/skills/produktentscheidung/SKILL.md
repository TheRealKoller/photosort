...
Die Stelle, die den Lauf gestartet hat, erkennt den Anker **im Rückgabewert** — nicht im laufenden Ausgabefenster — und hält ihren eigenen Schritt an. Sie:
