...
**Vergleichsstand der Drift-Prüfung:** Der Body, den dieser Schritt eben per `issue-body-schreiben` geschrieben hat, **ist** der Stand, gegen den der Nachlauf vor seinem Schreibzugriff vergleicht — auf diesem Weg gibt es keine Lesung aus dessen Schritt 0, die ihn sonst lieferte. Zwischen diesem Schreibzugriff und dem Anheften liegt der gesamte Ausarbeitungslauf; weicht die frische Lesung dort ab, hat jemand den Body inzwischen bearbeitet, und der Nachlauf hält an, statt ihn zu überschreiben.
