...
5. Gib das Ergebnis als kurze Ergänzung an den Aufrufer zurück — du schreibst die Spec-Datei nicht zwangsläufig selbst, bei Aufruf durch `idea-sharpener` übernimmt der Aufrufer das, sofern nicht anders vereinbart.
