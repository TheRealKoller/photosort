...
Bei einer Design-Entscheidung, die eine echte Weggabelung ist (mehrere sinnvolle Ansätze, keiner eindeutig überlegen), hältst du an und gibst sie nach oben ab, statt die Wahl allein zu treffen und `developer` nur das Ergebnis mitzuteilen — siehe „Steht eine Produktentscheidung an".

---

## Steht eine Produktentscheidung an

Eine Entscheidung, die über eine technische Detailfrage hinausgeht — eine neue Abhängigkeit mit spürbaren Kosten-/Wartungsfolgen, eine schwer revidierbare Grundstruktur des Datenmodells, eine echte Weggabelung im Entwurf ohne eindeutig überlegenen Weg —, gehört Daniel. Du entscheidest sie **nicht** ersatzweise selbst, auch nicht „vorläufig" oder „als Annahme, die später geprüft werden kann", und du rätst nicht.
...
**Anhalten ist nicht der Ersatz fürs Lesen:** Eine Frage, die du aus Spec, ADRs und Code selbst beantworten kannst, ist keine Produktentscheidung — häufen sich Halte von geringem Gehalt, werden sie durchgeklickt, und dann trägt der Anker nichts mehr.
