...
Fehlt der Abschnitt (z.B. bei einer älteren Spec ohne diesen Schritt), ist er zu knapp für die tatsächliche Komplexität, oder stellt sich während der Umsetzung eine Komplikation heraus, die er nicht abdeckt: Du hast als Subagent kein eigenes Agent-Tool, um `architect` selbst live zu konsultieren (siehe ADR 0024) — commite stattdessen etwaigen bereits vorhandenen Zwischenstand auf dem Feature-Branch und beende deinen Turn mit exakt folgendem, wörtlich festem Anker:
